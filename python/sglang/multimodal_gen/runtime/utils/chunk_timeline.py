...
CHUNK_TRACE_META_KEYS = (
    ...
    "real_audio_ms",
    "silence_audio_ms",
    "audio_delta_realign_applied",
    "audio_delta_leading_silence_dropped_ms",
    "real_audio_offset_before_ms",
    "real_audio_offset_after_ms",
    "audio_delta_realign_waited_for_full_window",
    "fifo_level_ms",
