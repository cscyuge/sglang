...
def get_is_diffusion_model(model_path: str) -> bool:
    ...
    Also checks multimodal_gen registry detectors for non-diffusers models
    (e.g. safetensors-only models like FlashTalk). For gated repos where file
    download fails, falls back to HF model card metadata
